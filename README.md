...
3. **CO2 Rate of Change Advantage**: $S5\_CO2\_Slope$ (rate of change) detects occupancy faster than raw $CO2$ PPM concentration, which suffers from room volume dilution lag.
...
│
├── main.py                             # Complete single-file Streamlit application
├── requirements.txt                    # Pinned core dependencies
├── README.md                           # Comprehensive project documentation
├── PROJECT_DOCUMENTATION.docx          # Complete 40-section technical report
